            ...
            <article>
                <div>
                    ...
                    <div className="reserveTablePage3Form">
                        ...
                        <h3>Dear {state.firstName} {state.lastName}, You have reserved the table at {state.reservationDateTime} for the {state.guestNumber} guest{state.guestNumber > 1 ? "s" : ""}.</h3>
